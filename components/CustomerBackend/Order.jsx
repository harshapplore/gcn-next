                    ...
                    return (
                        ...
                        <div className="flex pr15">
                            ...
                            <div className="flex50 flex">
                                <div className="flex50">
                                    <div className="light">Status</div>
                                    <div className="rubik mb-10">Shipped</div>
                                ...
                                <div className="flex50">
                                    <a href="#" className="button lowercase mb-10 block w-button color-white">Contact Seller</a>
                                    <a href="#" className="button red lowercase block w-button">Cancel Order</a>
                                </div>
                            </div> 
                        </div>
                        <div className="assessment-spacer" />
