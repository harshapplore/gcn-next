    ...
    return (
        <div className="flex-child-32">
            <div className="potw-item">
                ...
                <a className="potw-like active w-inline-block cursor" onClick={removeNReload}>
                    <img
        ...
        <div className="flex-child-32">
            <div className="potw-item">
                <img
                    ...
                    className="back-img"
                />
                <a className="potw-name w-inline-block" onClick={() => router.push(`/shop/${shop._id}?fiters={"shopName": "${shop?.name}"}`)}>
                    <div>{shop?.name}</div>
                    <img
                        src="/images/expand-more-black-24-dp.svg"
                        loading="lazy"
