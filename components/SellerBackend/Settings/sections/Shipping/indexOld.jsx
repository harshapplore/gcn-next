...
/* Dropdown Data */
import nationalAndInternational from "@/_data/nationalAndInternational.json";
...
const AddCountry = ({ availableCountries, close }) => {
  ...
  const [error, setError] = useState("");
console.log(nationalAndInternational)
  ...
  return (
    <div className={styles["shipping-add-ctr"]}>
      <Select
        choices={nationalAndInternational}
        value={""}
        placeholder={country}
        setValue={(index) => {
          setCountry(nationalAndInternational[index]);
        }}
        error={error}
      />
        ...
        <div className="w-form">
          <form id="email-form-3" name="email-form-3" data-name="Email Form 3">
            <div className="product-add-block">
              ...
              >
                <div className="delivery-country-text">Add Shipping Details</div>
              </div>
              {showAddCountry && (
