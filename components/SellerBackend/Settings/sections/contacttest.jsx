    ...
    <div className="settings-block">
      ...
      <div className="w-form">
        <div className="account-form-1">
          ...
          <TextInput
            placeholder={seller.shop.contactEmail ? seller.shop.contactEmail : "Email Contact Person"}
          ...
          <TextInput
            placeholder={
              seller.shop.orderManagementEmail || "Email Order Management"
            }
          ...
          <TextInput
            placeholder={seller.shop.returnsEmail || "Email Returns"}
          ...
          <TextInput
            placeholder={
              seller.shop.customerServiceEmail || "Email Customer Service"
            }
