...
const Seller_Shop_Shipping_Settings = ({ nextPage }) => {
  ...
  const [allowShippingToPackingStation, setAllowShippingToPackingStation] =
    useState(false);
  ...
  const [interNationalShippingMessage, setInterNationalShippingMessage] =
    useState("");
  ...
  useEffect(() => {
    if (
      sellerInfo &&
      sellerInfo.seller &&
      sellerInfo.seller.qaStatus &&
      sellerInfo.seller.qaStatus != "approved"
    ) {
      router.push("/");
    }
  }, [sellerInfo]);
  ...
  const nationalShipping = async (e) => {
    ...
    if (res.data)
      setNationalShippingMessage(
        "National shipping details updated successfully"
      );
  };
  const interNationalShipping = async (e) => {
    ...
    console.log(res.data);
    if (res.data)
      setInterNationalShippingMessage(
            ...
            <div className="w-form">
              <form>
                <div
                  ...
                  className="assessment-list assessment-list--3"
                >
                  <div>
                    ...
                    <select
                      ...
                      {countries.length && countries.map(option => <option key={option} value={option}>{option}</option>)}
                        ...
                        {showCountryDetails && (
                          <div>
                            <div className="delivery-cost-text">
                              ...
                              <div className="input-x input-x--flex">
                                ...
                                <div className="input-x__change">
                                  <div
                                    style={{ cursor: "pointer" }}
                                    onClick={() =>
                                      setEditCost0to1Kg(!editCost0to1Kg)
                                    }
                                  >
                                    Change
                                  </div>
                              ...
                              <div className="input-x input-x--flex">
                                ...
                                <div className="input-x__change">
                                  <div
                                    style={{ cursor: "pointer" }}
                                    onClick={() =>
                                      setEditCost1to5Kg(!editCost1to5Kg)
                                    }
                                  >
                                    Change
                                  </div>
                              ...
                              <div className="input-x input-x--flex">
                                ...
                                <div className="input-x__change">
                                  <div
                                    style={{ cursor: "pointer" }}
                                    onClick={() =>
                                      setEditCost5to10Kg(!editCost5to10Kg)
                                    }
                                  >
                                    Change
                                  </div>
                            ...
                            <div className="delivery-cost">
                              ...
                              <div className="input-x input-x--flex">
                                {!editcostMoreThan10Kg ? (
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setcostMoreThan10Kg(e.target.value)
                                    }
                            ...
                            {nationalShippingMessage && (
                              <h5>{nationalShippingMessage}</h5>
                            )}

                            <div className="delivery-cost-button-wrapper">
                              <div
                                onClick={nationalShipping}
                        ...
                        {interNational && (
                          <div>
                            ...
                            <div className="delivery-cost">
                              ...
                              <div className="input-x input-x--flex">
                                {!editCost0to1KgInt ? (
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setCost0to1KgInt(e.target.value)
                                    }
                                    value={cost0to1KgInt}
                                    type="text"
                                    className="input-x-edit w-input"
                                ...
                                <div className="input-x__change">
                                  <div
                                    style={{ cursor: "pointer" }}
                                    onClick={() =>
                                      setEditCost0to1KgInt(!editCost0to1KgInt)
                                    }
                                  >
                                    Change
                                  </div>
                            ...
                            <div className="delivery-cost">
                              ...
                              <div className="input-x input-x--flex">
                                {!editCost1to5KgInt ? (
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setCost1to5KgInt(e.target.value)
                                    }
                                    value={cost1to5KgInt}
                                    type="text"
                                    className="input-x-edit w-input"
                                ...
                                <div className="input-x__change">
                                  <div
                                    style={{ cursor: "pointer" }}
                                    onClick={() =>
                                      setEditCost1to5KgInt(!editCost1to5KgInt)
                                    }
                                  >
                                    Change
                                  </div>
                            ...
                            <div className="delivery-cost">
                              ...
                              <div className="input-x input-x--flex">
                                {!editCost5to10KgInt ? (
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setCost5to10KgInt(e.target.value)
                                    }
                                ...
                                <div className="input-x__change">
                                  <div
                                    style={{ cursor: "pointer" }}
                                    onClick={() =>
                                      setEditCost5to10KgInt(!editCost5to10KgInt)
                                    }
                                  >
                                    Change
                                  </div>
                            ...
                            <div className="delivery-cost">
                              ...
                              <div className="input-x input-x--flex">
                                {!editcostMoreThan10KgInt ? (
                                  ...
                                  <input
                                    onChange={(e) =>
                                      setcostMoreThan10KgInt(e.target.value)
                                    }
                            ...
                            {interNationalShippingMessage && (
                              <h5>{interNationalShippingMessage}</h5>
                            )}
                            <div className="delivery-cost-button-wrapper">
                              <div
                                onClick={interNationalShipping}
                                className="button blue mr-10"
                              >
                                Save Changes
                              </div>
                    ...
                    <div className="assessment-list-content">
                      ...
                      <div className="shipping-general-options">
                        <label className="w-checkbox checkbox-field mb-0">
                          ...
                          <span
                            ...
                            className="checkbox-label medium w-form-label"
                          >
                            Free Shipping from
                          </span>
                        </label>
                        {freeShippingFrom && (
                          <>
                            ...
                            <input
                              type="number"
                              className="input-x input-x--number input-x--free-shipping w-input"
                              onChange={(e) =>
                                setFreeShippingStart(e.target.value)
                              }
                            ...
                            <select
                              ...
                              className="input-x input-x--select input-x--eur w-select"
                            >
                              <option value="EUR">EUR</option>
                      ...
                      <div className="shipping-general-options">
                        <label className="w-checkbox checkbox-field mb-0">
                          ...
                          <input
                            type="checkbox"
                            id="Allow packing station"
                            checked={allowShippingToPackingStation}
                            style={{
                              opacity: 0,
                              position: "absolute",
                              zIndex: -1,
                            ...
                            onChange={() =>
                              setAllowShippingToPackingStation(
                                !allowShippingToPackingStation
                              )
                            }
                          />
                          <span
                            htmlFor="Allow packing station"
                      ...
                      <div className="shipping-general-options">
                        ...
                        ${CO2Neutral && "w--redirected-checked"}`}
                          ></div>
                          <input
                            type="checkbox"
                            id="CO2-neutral"
                            checked={CO2Neutral}
                            onChange={() => setCO2Neutral(!CO2Neutral)}
                            style={{
                              opacity: 0,
                              position: "absolute",
                              zIndex: -1,
                ...
                {loading ? (
                  ...
                  <div onClick={submit} className="button blue mr-10">
                    Save and Continue
                  </div>
                )}
              </form>
